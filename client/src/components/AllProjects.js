...
<AppBar className={classes.navbar}>
       <Toolbar>
           ...
           <NavLink className={classes.link} to='/addproject'> <button>Add User</button></NavLink>
   ...
   <Box style={{marginRight:"auto"}}>
      <TextField id="demo-helper-text-misaligned-no-helper" style={{color:"white"}} label="search" value={search} onChange={handleChange} onKeyDown={handleKeydown} />
    </Box>
      <TableContainer component={Paper} className={classes.tableContainer} sx={{maxHeight: 500}}>
        <Table className={classes.table} size='small' stickyHeader >
          ...
          <TableRow   >
                ...
                <TableCell className={classes.heading}>Project Description</TableCell>                
          ...
          <TableBody>
            {project.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((project, _id) =>{
                return(
                    ...
                    <TableRow>
                        ...
                        <TableCell>  
                          ...
                          <Button color="primary" variant="contained" style={{marginRight:10}}  component={Link} to={`/editproject/${project.id}`}>Edit</Button><br/>
                            {/* <Button color="secondary" variant="contained" onClick={()=>Deleteproject(project.id) } >Delete</Button> */}
                            <Button color="secondary" variant="contained" onClick={handleOpen} >Delete</Button>
   ...
   <div>
      ...
      >
        ...
        <button color='primary' value={project.id}  onClick={()=>DeleteProjectV1(project._id) }>confirm</button>
        </Box>
      </Modal>
    </div>
